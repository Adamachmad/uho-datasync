    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-3">
                @if($pengajuAuth)
                    {{-- Logged-in: account dropdown pakai Alpine click (bukan hover) --}}
                    <div x-data="{ dropOpen: false }" @click.outside="dropOpen = false" style="position:relative;">
                        ...
                        <div x-show="dropOpen"
                            ...
                            <a href="{{ route('dashboard') }}" style="display:flex; align-items:center; gap:.6rem; padding:.6rem 1rem; border-radius:8px; font-size:.875rem; font-weight:500; color:#1e293b; text-decoration:none; transition:background .15s;"
                            ...
                            <a href="{{ route('profile.edit') }}" style="display:flex; align-items:center; gap:.6rem; padding:.6rem 1rem; border-radius:8px; font-size:.875rem; font-weight:500; color:#1e293b; text-decoration:none; transition:background .15s;"
                               onmouseover="this.style.background='#f0f4ff'" onmouseout="this.style.background='transparent'">
